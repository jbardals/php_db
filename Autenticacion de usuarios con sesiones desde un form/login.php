...
$usuario_correcto = "miguel";
$palabra_secreta_correcta = "abc123.";
/*
Para leer los datos que fueron enviados al formulario,
accedemos a la variable superglobal llamado $_POST en PHP, y
...
if ($usuario === $usuario_correcto && $palabra_secreta === $palabra_secreta_correcta) {
    ...
    # en la variable superglobal $_SESSION, ya que ese arreglo
